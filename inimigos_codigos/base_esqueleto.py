...
# Classe base para inimigos do tipo Esqueleto (usa novas animações e colisão com hitbox separada)
class InimigoBase(pygame.sprite.Sprite):
    def __init__(self, x, y, hp_max, velocidade, alvo, inimigos_group):
        ...
        # Hitbox usada para colisão real com o mapa (separada do sprite)
        self.hitbox_rect = pygame.Rect(0, 0, 35, 60)
        self.hitbox_rect.center = self.rect.center

        self.mask = pygame.mask.from_surface(self.image)

        # Atributos de status e movimentação
        self.hp_max = hp_max
    ...
    # Evita sobreposição de inimigos próximos
    ...
    # Carrega todas as animações com escalas aplicadas
    def carregar_animacoes(self):
        animacoes = {'parado': [], 'andando': [], 'morrendo': [], 'ataque1': [], 'ataque2': [], 'dano': []}
    ...
    # Retorna True se estiver próximo o suficiente do jogador para atacar
    ...
    # Lógica de movimentação em direção ao jogador, com desvio de outros inimigos
    ...
    # Atualiza a animação com base no tempo e executa dano caso esteja atacando
    ...
    # Aplica dano ao inimigo, troca para animação de dano ou morte
    ...
    # Verifica e corrige colisão com paredes do mapa usando a hitbox
    def verificar_colisao(self, tilemap):
        ...
        # Atualiza a posição visível para manter o sprite alinhado com a hitbox
