...
class Soldado(pygame.sprite.Sprite):
    def __init__(self, animacoes):
        ...
        self.tempo_animacao = 100  # Tempo padrão para outras animações
        self.tempo_animacao_morte = 1000  # Tempo específico para a animação de morte
    ...
    def update(self, teclas):
        ...
        # Lógica de morte (bloqueia tudo se estiver morto)
        if self.esta_morto:
        ...
        # Lógica normal (apenas se não estiver morto)
        ...
        # Atualização de animação normal
        ...
        elif self.animacao_dano_ativa:
            frame = self.animacoes['dano'][self.indice_animacao]
        else:
    ...
    def receber_dano(self, quantidade):
        if not self.esta_morto and not self.animacao_dano_ativa:
            ...
            if self.hp_atual <= 0:
                self.esta_morto = True  # Ativa estado de morte
            else:
